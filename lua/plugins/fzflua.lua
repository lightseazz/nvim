return {
	...
	keys = {
		...
		{ "<leader>b", ':lua require("fzf-lua").buffers()<CR>', silent = true, desc = "search list buffers" },
		{ "<leader>fk", ':lua require("fzf-lua").keymaps()<CR>', silent = true, desc = "search keymap" },
		{ "<leader>f/", ':lua require("fzf-lua").live_grep()<CR>', silent = true, desc = "search live grep" },
		{ "<leader><leader>", ':lua require("fzf-lua").resume()<CR>', silent = true, desc = "resume fzf lua" },
